...
for cutoff_frac in sorted(s):
    ...
    plt.savefig("niceplots/sigma_hist/sigmhist_" + str(cutoff_frac) + ".pdf")
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig("niceplots/pi_evol/sigmaevol_" + str(cutoff_frac) + ".pdf")
    plt.close()
    ...
    plt.title(r"$s=\Lambda' / \Lambda$ = " + str(cutoff_frac), fontsize=22)
    plt.tight_layout()
    plt.savefig("niceplots/sigma_evol/pievol_" + str(cutoff_frac) + ".pdf")
    plt.close()
    ...
    plt.title(r"$s=\Lambda' / \Lambda$ = " + str(cutoff_frac), fontsize=22)
    plt.tight_layout()
    plt.savefig("niceplots/pi2_evol/pi2_evol_" + str(cutoff_frac) + ".pdf")
    plt.close()
...
plt.tight_layout()
#plt.ylim([0.78, 0.79])
plt.savefig("niceplots/condensates/sigma.pdf")
plt.close()
...
plt.yscale('log')
#plt.ylim([0.0, 0.02])
plt.savefig("niceplots/condensates/pi1.pdf")
plt.close()
...
plt.savefig("niceplots/condensates/pi2.pdf")
plt.close()
...
plt.tight_layout()
#plt.ylim([0.28, 0.283])
plt.savefig("niceplots/condensates/pi3.pdf")
plt.close()
...
plt.tight_layout()
#plt.ylim([0, 0.03])
plt.savefig("niceplots/pions.pdf")
plt.close()
