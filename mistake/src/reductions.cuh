...
// --------------------------------------------------------------------------------------
// Q: is sizeof(thrust::complex<double>) == 2*sizeof(double)? --> reduce number of functions
...
__global__ void copyVec_double(double *v1, double *v2, int const vol); // copy v2 into v1
